...
====== TODO
ESSENTIALS
* protein pages --> DOMAINS AND FEATURES (graph is done but you need graphviz installed)
- --> https://google-developers.appspot.com/chart/interactive/docs/gallery/timeline for the plots?
* user handling
- --> https://github.com/NoamB/sorcery/blob/master/README.md - looks good?

* evidences/show/70099 --> fix views
* why does this throw an error: "Evidence.find(70099).inhibitions"
